...
def test_add_person_to_db_with_dates(
    test_db, surname, name, last_contact_date, expected
):
...
def test_update_last_contact_date(
    test_db, surname, name, last_contact_date, contact_date, expected
):
